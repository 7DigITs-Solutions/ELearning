...
public class Level1_Lesson1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level1_lesson1);
        ...
        txt1 = (CardView) findViewById(R.id.txt1_lev1_lesson1);
        video1 = (CardView) findViewById(R.id.video1_lev1_lesson1);
        ...
        txt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Level1_Lesson1_Activity.this, Level1_Lesson1_txt1_Activity.class);
        ...
        video1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentvideo1 = new Intent(Level1_Lesson1_Activity.this, Lesson1Level1Activity.class);
                ActivityOptionsCompat options = ActivityOptionsCompat.
                        makeSceneTransitionAnimation(Level1_Lesson1_Activity.this, imageView
