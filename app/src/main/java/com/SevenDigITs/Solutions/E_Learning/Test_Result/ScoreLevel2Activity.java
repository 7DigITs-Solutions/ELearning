...
public class ScoreLevel2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) findViewById(R.id.circle_progress_barLvl2);
        textViewPresentatge = (TextView) findViewById(R.id.presentatageLvl2);
        textViewScore = (TextView) findViewById(R.id.scoreLvl2);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ScoreLevel2Activity.this, MainActivity.class);
